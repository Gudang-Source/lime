            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <?php $siswa = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM siswa")); ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                <?php $guru = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM guru")); ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                <?php $upload = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM elearning")); ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                <?php $forum = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM forum_topic")); ?>
