                  ...
                  <form style='margin-right:5px; margin-top:0px' class='pull-right' action='' method='GET'>
                    ...
                    <select name='tahun' style='padding:4px'>
                        <?php 
                            ...
                            $tahun = mysql_query("SELECT * FROM tahun_akademik");
                ...
                <div class="box-body">
                  ...
                  <?php
                    if (isset($_GET[kelas]) AND isset($_GET[tahun])){
                      $tampil = mysql_query("SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_pelajaran, b.kode_kurikulum, c.nama_guru, d.nama_ruangan FROM jadwal_pelajaran a 
                    ...
                    $total = mysql_num_rows(mysql_query("SELECT * FROM quiz_ujian where kodejdwl='$r[kodejdwl]'"));
                    echo "<tr><td>$no</td>
...
cek_session_guru();
    $d = mysql_fetch_array(mysql_query("SELECT * FROM kelas where kode_kelas='$_GET[id]'"));
    $m = mysql_fetch_array(mysql_query("SELECT * FROM mata_pelajaran where kode_pelajaran='$_GET[kd]'"));
              ...
              <table class='table table-condensed table-hover'>
                ...
                <div class='col-md-12'>
                  <table id='example1' class='table table-condensed table-bordered table-striped'>
                    ...
                    $no = 1;
                    $tampil = mysql_query("SELECT * FROM quiz_ujian a JOIN kategori_quiz_ujian b ON a.id_kategori_quiz_ujian=b.id_kategori_quiz_ujian where a.kodejdwl='$_GET[jdwl]' ORDER BY a.id_quiz_ujian");
                    while($r=mysql_fetch_array($tampil)){
                    echo "<tr>
                            <td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                        mysql_query("DELETE FROM quiz_ujian where id_quiz_ujian='$_GET[hapus]'");
...
cek_session_guru();
  if (isset($_POST[tambah])){
    ...
    mysql_query("INSERT INTO quiz_ujian VALUES ('','$_POST[a]','$_GET[jdwl]','$_POST[b]','$bataswaktu')");
      echo "<script>document.location='index.php?view=soal&act=listsoal&jdwl=".$_GET[jdwl]."&id=".$_GET[id]."&kd=".$_GET[kd]."';</script>";
  }
                  ...
                  <tbody>
                    <tr><th width='120px' scope='row'>Kategori</th> <td><select class='form-control' name='a'> 
                             <option value='0' selected>- Pilih Kategori -</option>"; 
                              $kategori = mysql_query("SELECT * FROM kategori_quiz_ujian");
...
cek_session_guru();
      $so = mysql_fetch_array(mysql_query("SELECT * FROM quiz_ujian a 
                        JOIN kategori_quiz_ujian b ON a.id_kategori_quiz_ujian=b.id_kategori_quiz_ujian 
                          ...
                          if (isset($_POST[essai])){
                            mysql_query("INSERT INTO pertanyaan_essai VALUES('','$_GET[idsoal]','$_POST[a]')");
                          ...
                          if (isset($_POST[objektif])){
                            mysql_query("INSERT INTO pertanyaan_objektif VALUES('','$_GET[idsoal]','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','$_POST[g]')");
                            echo "<script>document.location='index.php?view=soal&act=semuasoal&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[id]&kd=$_GET[kd]';</script>";
                          }

                          if (isset($_GET[deleteessai])){
                            mysql_query("DELETE FROM pertanyaan_essai where id_pertanyaan_essai='$_GET[deleteessai]'");
                            echo "<script>document.location='index.php?view=soal&act=semuasoal&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[id]&kd=$_GET[kd]';</script>";
                          }

                          if (isset($_GET[deleteobjektif])){
                            mysql_query("DELETE FROM pertanyaan_objektif where id_pertanyaan_objektif='$_GET[deleteobjektif]'");
                            echo "<script>document.location='index.php?view=soal&act=semuasoal&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[id]&kd=$_GET[kd]';</script>";
                          }
              ...
              <div class='box'>
                ...
                <div class='box-body'>
                  <table class='table table-condensed table-bordered table-striped'>
                    ...
                    $essai = mysql_query("SELECT * FROM `pertanyaan_essai` where id_quiz_ujian='$_GET[idsoal]' ORDER BY id_pertanyaan_essai DESC");
                    $no = 1;
              ...
              <div class='box'>
                ...
                <div class='box-body'>
                  <table class='table table-condensed table-bordered'>
                    ...
                    $objektif = mysql_query("SELECT * FROM `pertanyaan_objektif` where id_quiz_ujian='$_GET[idsoal]' ORDER BY id_pertanyaan_objektif DESC");
                    $noo = 1;
...
cek_session_guru();
    $d = mysql_fetch_array(mysql_query("SELECT a.*, b.*, c.*, d.*, e.*, f.nama_guru as nama_guru, f.nip FROM quiz_ujian a 
              ...
              <table class='table table-condensed table-hover'>
                ...
                <div class='col-md-12'>
                  <table class='table table-condensed table-bordered table-striped'>
                    ...
                    $no = 1;
                    $tampil = mysql_query("SELECT * FROM siswa a JOIN jenis_kelamin b ON a.id_jenis_kelamin=b.id_jenis_kelamin 
                                              where a.kode_kelas='$_GET[id]' ORDER BY a.nisn ASC");
                    while($r=mysql_fetch_array($tampil)){
                    $to = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM `jawaban_objektif` a 
                    ...
                    $es = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM jawaban_essai a JOIN pertanyaan_essai b 
...
cek_session_guru();
      $so = mysql_fetch_array(mysql_query("SELECT * FROM quiz_ujian a 
                        JOIN kategori_quiz_ujian b ON a.id_kategori_quiz_ujian=b.id_kategori_quiz_ujian 
                          JOIN jadwal_pelajaran c ON a.kodejdwl=c.kodejdwl 
                            JOIN kelas d ON c.kode_kelas=d.kode_kelas where a.id_quiz_ujian='$_GET[idsoal]'"));
      $si = mysql_fetch_array(mysql_query("SELECT * FROM siswa where nisn='$_GET[noinduk]'"));

      if (isset($_POST[nilaiessai])){
          $ce = mysql_fetch_array(mysql_query("SELECT count(*) as cek FROM nilai_pertanyaan_essai where id_quiz_ujian='$_GET[idsoal]' AND nisn='$_GET[noinduk]'"));
          if ($ce[cek] >= 1){
            mysql_query("UPDATE nilai_pertanyaan_essai SET nilai_essai='$_POST[a]' where id_quiz_ujian='$_GET[idsoal]' AND nisn='$_GET[noinduk]'");
            ...
            mysql_query("INSERT INTO nilai_pertanyaan_essai VALUES('','$_GET[idsoal]','$_GET[noinduk]','$_POST[a]')");
            echo "<script>document.location='index.php?view=soal&act=semuajawabansiswa&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[id]&kd=$_GET[kd]&noinduk=$_GET[noinduk]';</script>";
          }
      }
      // Rumus Menghitung Total Nilai
      $objek = mysql_query("SELECT * FROM `pertanyaan_objektif` where id_quiz_ujian='$_GET[idsoal]' ORDER BY id_pertanyaan_objektif DESC");
      ...
      $nli = mysql_fetch_array(mysql_query("SELECT * FROM nilai_pertanyaan_essai where nisn='$_GET[noinduk]' AND id_quiz_ujian='$_GET[idsoal]'"));
              ...
              <div class='box'>
                ...
                <div class='box-body'>
                  ...
                  <table class='table table-condensed table-bordered'>
                    ...
                    $no = 1;
                    while ($k = mysql_fetch_array($essai)){
                      $je = mysql_fetch_array(mysql_query("SELECT * FROM jawaban_essai where id_pertanyaan_essai='$k[id_pertanyaan_essai]' AND nisn='$_GET[noinduk]'"));
                        echo "<tr>
                            <td>$no</td>
              ...
              echo "<div class='box'>
                ...
                <div class='box-body'>
                  ...
                  <table class='table table-condensed table-bordered'>
                    ...
                    $noo = 1;
                    while ($ko = mysql_fetch_array($objektif)){
                      $jo = mysql_fetch_array(mysql_query("SELECT * FROM jawaban_objektif where id_pertanyaan_objektif='$ko[id_pertanyaan_objektif]' AND nisn='$_GET[noinduk]'"));
...
cek_session_siswa();
    $jml = mysql_fetch_array(mysql_query("SELECT count(*) as jmlp FROM `pertanyaan_objektif` where id_quiz_ujian='$_GET[idsoal]'"));
       ...
       for ($i=0; $i<=$n; $i++){
         if (isset($_POST['a'.$i])){
           ...
           $pertanyaan = $_POST['b'.$i];
            $cek = mysql_fetch_array(mysql_query("SELECT count(*) as tot FROM jawaban_objektif where nisn='$iden[nisn]' AND id_pertanyaan_objektif='$pertanyaan'"));
            if ($cek[tot] >= 1){
              mysql_query("UPDATE jawaban_objektif SET jawaban='$jawab' where id_pertanyaan_objektif='$pertanyaan' AND nisn='$iden[nisn]'");
            }else{
              $waktuobjektif = date("Y-m-d H:i:s");
              mysql_query("INSERT INTO jawaban_objektif (nisn, id_pertanyaan_objektif, jawaban, waktu_objektif) VALUES('$iden[nisn]','$pertanyaan','$jawab','$waktuobjektif')");
          }
         }
       }
              ...
              <div class='box'>
                ...
                <div class='box-body'>
                  <table class='table table-condensed table-bordered table-striped'>
                    ...
                    $no = 1;
                    while ($k = mysql_fetch_array($essai)){
                       $je = mysql_fetch_array(mysql_query("SELECT * FROM jawaban_essai where id_pertanyaan_essai='$k[id_pertanyaan_essai]' AND nisn='$iden[nisn]'"));
                        echo "<tr>
                            <td>$no</td>
                            <td>$k[pertanyaan_essai] <br>
              ...
              <div class='box'>
                ...
                <form action='' method='POST'>
                  <table class='table table-condensed table-bordered'>
                    ...
                    $noo = 1;
                    while ($ko = mysql_fetch_array($objektif)){
                      $ce = mysql_fetch_array(mysql_query("SELECT * FROM jawaban_objektif where id_pertanyaan_objektif='$ko[id_pertanyaan_objektif]' AND nisn='$iden[nisn]'"));
                        echo "<tr>
                            <td>$noo</td>
                            <td>$ko[pertanyaan_objektif] <br>
...
cek_session_siswa();
    if (isset($_POST[simpan])){
      $cek = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM jawaban_essai where nisn='$iden[nisn]' AND id_pertanyaan_essai='$_GET[idp]'"));
      if ($cek[total]>=1){
          mysql_query("UPDATE jawaban_essai SET jawaban_essai = '$_POST[a]' where nisn='$iden[nisn]' AND id_pertanyaan_essai='$_GET[idp]'");
      }else{
          $waktujawab = date("Y-m-d H:i:s");
          mysql_query("INSERT INTO jawaban_essai VALUES('','$iden[nisn]','$_GET[idp]','$_POST[a]','$waktujawab')");
      } 
      echo "<script>document.location='index.php?view=soal&act=jawabsemuasoal&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[id]&kd=$_GET[kd]';</script>";
    }

    $n = mysql_fetch_array(mysql_query("SELECT * FROM jawaban_essai where nisn='$iden[nisn]' AND id_pertanyaan_essai='$_GET[idp]'"));
