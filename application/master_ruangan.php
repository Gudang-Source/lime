              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM ruangan a 
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM ruangan where kode_ruangan='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE ruangan SET kode_ruangan = '$_POST[a]',
                                         kode_gedung = '$_POST[b]',
    ...
    $edit = mysql_query("SELECT * FROM ruangan where kode_ruangan='$_GET[id]'");
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Nama Gedung</th>          <td><select class='form-control' name='b'> 
                                                                          <option value='0' selected>- Pilih Gedung -</option>"; 
                                                                            $wali = mysql_query("SELECT * FROM gedung");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO ruangan VALUES('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','$_POST[g]')");
        echo "<script>document.location='index.php?view=ruangan';</script>";
    }
