              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM psb_aktivasi ORDER BY id_aktivasi DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM psb_aktivasi where id_aktivasi='$_GET[hapus]'");
                      ...
                      if (isset($_POST[tambahkan])){
                          ...
                          mysql_query("INSERT INTO psb_aktivasi VALUES('','$kode','$_POST[nama]','$_POST[status]','0','".date('Y-m-d H:i:s')."')");
                          echo "<script>document.location='index.php?view=psbaktivasi';</script>";
                      }
...
<?php 
    ...
    if (isset($_POST[update])){
      $cek = mysql_fetch_array(mysql_query("SELECT * FROM psb_aktivasi where id_aktivasi='$_POST[id]'"));
      if ($cek[status]==$_POST[b]){
        ...
        mysql_query("UPDATE psb_aktivasi SET kode_pendaftaran = '$kodea',
                                                nama_lengkap = '$_POST[a]',
                                                status = '$_POST[b]' where id_aktivasi='$_POST[id]'");
      echo "<script>document.location='index.php?view=psbaktivasi';</script>";
    }
    $edit = mysql_query("SELECT * FROM psb_aktivasi where id_aktivasi='$_GET[id]'");
