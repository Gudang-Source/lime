              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php
                    ...
                    $total = mysql_num_rows(mysql_query("SELECT * FROM elearning where kodejdwl='$r[kodejdwl]'"));
                    echo "<tr><td>$no</td>
              ...
              <input type='hidden' name='pelajaran' value='$_GET[kd]'>
                <div class='col-md-12'>
                  <table id='example1' class='table table-condensed table-bordered table-striped'>
                    ...
                    $no = 1;
                    $tampil = mysql_query("SELECT * FROM elearning a JOIN kategori_elearning b ON a.id_kategori_elearning=b.id_kategori_elearning where kodejdwl='$_GET[jdwl]' ORDER BY a.id_elearning");
                    while($r=mysql_fetch_array($tampil)){
                      echo "<tr>
                              <td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                        mysql_query("DELETE FROM elearning where id_elearning='$_GET[hapus]'");
...
if (isset($_POST[tambah])){
      ...
      if ($filename != ''){      
        if (move_uploaded_file($_FILES['c']['tmp_name'], $uploadfile)) {
          mysql_query("INSERT INTO elearning VALUES ('','$_POST[a]','$_GET[jdwl]','$_POST[b]','$filenamee','$_POST[d]','$_POST[e]','$_POST[f]')");
            echo "<script>document.location='index.php?view=bahantugas&act=listbahantugas&jdwl=".$_GET[jdwl]."&id=".$_GET[id]."&kd=".$_GET[kd]."';</script>";
        }else{
        ...
        mysql_query("INSERT INTO elearning VALUES ('','$_POST[a]','$_GET[jdwl]','$_POST[b]','','$_POST[d]','$_POST[e]','$_POST[f]')");
        echo "<script>document.location='index.php?view=bahantugas&act=listbahantugas&jdwl=".$_GET[jdwl]."&id=".$_GET[id]."&kd=".$_GET[kd]."';</script>";
      }
  }
                  ...
                  <tbody>
                    <tr><th width='120px' scope='row'>Kategori</th> <td><select class='form-control' name='a'> 
                             <option value='0' selected>- Pilih Kategori Tugas -</option>"; 
                              $kategori = mysql_query("SELECT * FROM kategori_elearning");
...
if (isset($_POST[update])){
      ...
      if ($filename != ''){      
        if (move_uploaded_file($_FILES['c']['tmp_name'], $uploadfile)) {
          mysql_query("UPDATE elearning SET id_kategori_elearning = '$_POST[a]',
                                               kodejdwl              = '$_GET[jdwl]',
                                               nama_file             = '$_POST[b]',
...
$edit = mysql_query("SELECT * FROM elearning a JOIN kategori_elearning b ON a.id_kategori_elearning=b.id_kategori_elearning where a.id_elearning='$_GET[edit]'");
...
?>
             <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?php if (isset($_GET[kelas]) AND isset($_GET[tahun])){ echo "Bahan dan Tugas"; }else{ echo "Bahan dan Tugas ".date('Y'); } ?></h3>
                  <form style='margin-right:5px; margin-top:0px' class='pull-right' action='' method='GET'>
                    <input type="hidden" name='view' value='bahantugas'>
...
cek_session_siswa();
$cek = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM elearning_jawab where id_elearning='$_GET[ide]' AND nisn='$iden[nisn]'"));
  if ($cek[total] >= 1){
    ...
    if (isset($_POST[kirimkan])){
          ...
          if ($filename != ''){    
            ...
            if (move_uploaded_file($_FILES['c']['tmp_name'], $uploadfile)) {
              mysql_query("INSERT INTO elearning_jawab VALUES ('','$_GET[ide]','$iden[nisn]','$_POST[a]','$filenamee','$waktuu')");
                echo "<script>document.location='index.php?view=bahantugas&act=listbahantugas&jdwl=".$_GET[jdwl]."&id=".$_GET[id]."&kd=".$_GET[kd]."';</script>";
            }else{
     ...
     echo "<div class='col-xs-12'>  
              <div class='box'>
                ...
                <table class='table table-bordered table-striped'>
                    ...
                    $tampil = mysql_query("SELECT * FROM elearning_jawab a JOIN siswa b ON a.nisn=b.nisn ORDER BY a.id_elearning_jawab DESC");
                    $no = 1;
                    while($r=mysql_fetch_array($tampil)){
                    echo "<tr><td>$no</td>
                              <td>$r[nisn]</td>
...
cek_session_guru();
    $d = mysql_fetch_array(mysql_query("SELECT * FROM kelas where kode_kelas='$_GET[id]'"));
    $m = mysql_fetch_array(mysql_query("SELECT * FROM mata_pelajaran where kode_pelajaran='$_GET[kd]'"));
    $t = mysql_fetch_array(mysql_query("SELECT * FROM elearning where id_elearning='$_GET[ide]'"));
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>List Upload Bahan dan Tugas</b></h3>
              ...
              <input type='hidden' name='pelajaran' value='$_GET[kd]'>
                <div class='col-md-12'>
                  <table id='example1' class='table table-condensed table-bordered table-striped'>
                    ...
                    $no = 1;
                    $tampil = mysql_query("SELECT * FROM elearning_jawab a JOIN siswa b ON a.nisn=b.nisn where a.id_elearning='$_GET[ide]' ORDER BY a.id_elearning_jawab DESC");
                    while($r=mysql_fetch_array($tampil)){
                      echo "<tr>
                              <td>$no</td>
