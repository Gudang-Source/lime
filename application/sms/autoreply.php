              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM sms_autoreply ORDER BY id_autoreply DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM sms_autoreply where id_autoreply='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE sms_autoreply SET keyword = '$_POST[a]',
                                         isi_pesan = '$_POST[b]' where id_autoreply='$_POST[id]'");
      echo "<script>document.location='index.php?view=autoreply';</script>";
    }
    $edit = mysql_query("SELECT * FROM sms_autoreply where id_autoreply='$_GET[id]'");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO sms_autoreply VALUES('','$_POST[a]','$_POST[b]','".date('Y-m-d H:i:s')."')");
        echo "<script>document.location='index.php?view=autoreply';</script>";
    }
