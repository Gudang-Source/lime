              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM kelompok_mata_pelajaran ORDER BY id_kelompok_mata_pelajaran DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM kelompok_mata_pelajaran where id_kelompok_mata_pelajaran='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE kelompok_mata_pelajaran SET jenis_kelompok_mata_pelajaran = '$_POST[a]',
                                         nama_kelompok_mata_pelajaran = '$_POST[b]' where id_kelompok_mata_pelajaran='$_POST[id]'");
      echo "<script>document.location='index.php?view=kelompokmapel';</script>";
    }
    $edit = mysql_query("SELECT * FROM kelompok_mata_pelajaran where id_kelompok_mata_pelajaran='$_GET[id]'");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO kelompok_mata_pelajaran VALUES('','$_POST[a]','$_POST[b]')");
        echo "<script>document.location='index.php?view=kelompokmapel';</script>";
    }
