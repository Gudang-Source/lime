              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM kelas a LEFT JOIN guru b ON a.nip=b.nip 
                    ...
                    $hitung = mysql_num_rows(mysql_query("SELECT * FROM siswa where kode_kelas='$r[kode_kelas]'"));
                    echo "<tr><td>$no</td>
                              <td>$r[kode_kelas]</td>
                              <td>$r[nama_kelas]</td>
                              <td>$r[nama_guru]</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM kelas where kode_kelas='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE kelas SET kode_kelas = '$_POST[a]',
                                         nip = '$_POST[b]',
    ...
    $edit = mysql_query("SELECT * FROM kelas a LEFT JOIN guru b ON a.nip=b.nip 
                            LEFT JOIN jurusan c ON a.kode_jurusan=c.kode_jurusan 
                              LEFT JOIN ruangan d ON a.kode_ruangan=d.kode_ruangan 
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Wali Kelas</th>               <td><select class='form-control' name='b'> 
                                                                          <option value='0' selected>- Pilih Wali Kelas -</option>"; 
                                                                            $wali = mysql_query("SELECT * FROM guru");
                    ...
                    <tr><th scope='row'>Ruangan</th>               <td><select class='form-control' name='d'> 
                                                                          <option value='0' selected>- Pilih Ruangan -</option>"; 
                                                                            $rua = mysql_query("SELECT * FROM ruangan a JOIN gedung b ON a.kode_gedung=b.kode_gedung ");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO kelas VALUES('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]')");
        echo "<script>document.location='index.php?view=kelas';</script>";
    }
