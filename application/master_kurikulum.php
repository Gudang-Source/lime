              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM kurikulum ORDER BY kode_kurikulum DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM kurikulum where kode_kurikulum='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE kurikulum SET nama_kurikulum = '$_POST[a]',
                                         status_kurikulum = '$_POST[b]' where kode_kurikulum='$_POST[id]'");
      echo "<script>document.location='index.php?view=kurikulum';</script>";
    }
    $edit = mysql_query("SELECT * FROM kurikulum where kode_kurikulum='$_GET[id]'");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO kurikulum VALUES('','$_POST[a]','$_POST[b]')");
        echo "<script>document.location='index.php?view=kurikulum';</script>";
    }
