              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM menu where status='psb' ORDER BY id_menu DESC");
                    $no = 1;
                    while($r=mysql_fetch_array($tampil)){
                    $sub = mysql_fetch_array(mysql_query("SELECT * FROM menu where id_menu='$r[id_parent]'"));
                    if ($sub[nama_menu] != ''){
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE menu SET id_parent = '$_POST[a]',
                                        nama_menu = '$_POST[b]',
                                        icon = '$_POST[c]',
                                        link = '$_POST[d]',
                                        aktif = '$_POST[e]',
                ...
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Sub Menu</th> <td>
                        ...
                        $sub = mysql_query("SELECT * FROM menu where id_parent='0' AND status='psb'");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO menu VALUES('','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','psb')");
        echo "<script>document.location='index.php?view=psbmenu';</script>";
    }
