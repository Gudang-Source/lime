...
<?php 
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO jadwal_pelajaran VALUES('','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','$_POST[g]','$_POST[h]','$_POST[i]','$_POST[j]','$_POST[k]')");
        echo "<script>document.location='index.php?view=jadwalpelajaran';</script>";
    }
                ...
                <div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Ruangan</th>   <td><select class='form-control' name='d'> 
                                                ...
                                                $ruangan = mysql_query("SELECT * FROM ruangan a JOIN gedung b ON a.kode_gedung=b.kode_gedung");
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE jadwal_pelajaran SET id_tahun_akademik = '$_POST[a]',
                                                    kode_kelas = '$_POST[b]',
    ...
    $e = mysql_fetch_array(mysql_query("SELECT * FROM jadwal_pelajaran where kodejdwl='$_GET[id]'"));
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
