...
<?php 
    ...
    $d = mysql_fetch_array(mysql_query("SELECT * FROM jadwal_pelajaran a JOIN mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran JOIN kelas c ON a.kode_kelas=c.kode_kelas where a.kodejdwl='$_GET[kodejdwl]'"));
              ...
              <div class='box'>
                ...
                <div class='box-body'>
                  ...
                  <table class='table table-bordered table-striped'>
                    ...
                    <tbody>";
                      $tampil = mysql_query("SELECT * FROM kompetensi_dasar z JOIN jadwal_pelajaran a ON z.kodejdwl=a.kodejdwl JOIN kelas b ON a.kode_kelas=b.kode_kelas JOIN mata_pelajaran c ON a.kode_pelajaran=c.kode_pelajaran where a.kodejdwl='$_GET[kodejdwl]' ORDER BY z.id_kompetensi_dasar DESC");
                    $no = 1;
                    while($r=mysql_fetch_array($tampil)){
                    echo "<tr><td>$no</td>
                              <td>$r[nama_kelas]</td>
