            ...
            <div class="col-xs-12">  
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php
                    if (isset($_GET[kelas])){
                      $tampil = mysql_query("SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_kurikulum, b.kode_pelajaran, c.nama_guru, d.nama_ruangan FROM jadwal_pelajaran a 
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                        mysql_query("DELETE FROM jadwal_pelajaran where kodejdwl='$_GET[hapus]'");
