              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM jurusan ORDER BY kode_jurusan DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM jurusan where kode_jurusan='$_GET[hapus]'");
...
<?php 
    ...
    $edit = mysql_query("SELECT * FROM jurusan where kode_jurusan='$_GET[id]'");
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE jurusan SET kode_jurusan = '$_POST[a]',
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO jurusan VALUES('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','$_POST[g]','$_POST[h]','$_POST[i]','$_POST[j]')");
        echo "<script>document.location='index.php?view=jurusan';</script>";
    }
