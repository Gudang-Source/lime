<?php if ($_GET[act]==''){
    if (isset($_POST[update])){
        mysql_query("UPDATE identitas_sekolah SET nama_sekolah   = '$_POST[a]',
                                         npsn = '$_POST[b]',
                                         nss = '$_POST[c]',
    ...
    $edit = mysql_query("SELECT * FROM identitas_sekolah ORDER BY id_identitas_sekolah DESC LIMIT 1");
