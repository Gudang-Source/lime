            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?php if (isset($_GET[tahun])){ echo "Data Kompetensi Dasar"; }else{ echo "Data Kompetensi Dasar pada ".date('Y'); } ?></h3>
                ...
                <div class="box-body">
                  ...
                  <?php
                    if (isset($_GET[tahun])){
                      $tampil = mysql_query("SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_pelajaran, c.nama_guru, d.nama_ruangan FROM jadwal_pelajaran a 
...
<?php 
    ...
    $d = mysql_fetch_array(mysql_query("SELECT a.kode_kelas, b.nama_kelas, c.namamatapelajaran, d.nama_guru FROM `jadwal_pelajaran` a JOIN kelas b ON a.kode_kelas=b.kode_kelas JOIN mata_pelajaran c ON a.kode_pelajaran=c.kode_pelajaran JOIN guru d ON a.nip=d.nip where a.kodejdwl='$_GET[id]'"));
              ...
              <div class='box'>
                ...
                <div class='box-body'>
                  ...
                  <table id='example' class='table table-bordered table-striped'>
                    ...
                    <tbody>";
                      $tampil = mysql_query("SELECT * FROM kompetensi_dasar z JOIN jadwal_pelajaran a ON z.kodejdwl=a.kodejdwl JOIN kelas b ON a.kode_kelas=b.kode_kelas JOIN mata_pelajaran c ON a.kode_pelajaran=c.kode_pelajaran where a.kodejdwl='$_GET[id]' ORDER BY z.id_kompetensi_dasar DESC");
                    $no = 1;
                    while($r=mysql_fetch_array($tampil)){
                    echo "<tr><td>$no</td>
                              <td>$r[ranah]</td>
                              ...
                              if($_SESSION[level]!='kepala'){
                                echo "<td style='width:80px !important'><center>
                                        ...
                                        <a class='btn btn-danger btn-xs' title='Delete Data' href='index.php?view=kompetensiguru&hapus=$r[id_kompetensi_dasar]&jdwl=$_GET[id]'><span class='glyphicon glyphicon-remove'></span></a>
                                      </center></td>";
                              }
                            echo "</tr>";
                      $no++;
                      ...
                      if (isset($_GET[hapus])){
                        mysql_query("DELETE FROM kompetensi_dasar where id_kompetensi_dasar='$_GET[hapus]'");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO kompetensi_dasar VALUES('','$_POST[jdwl]','$_POST[e]','$_POST[f]','".date('Y-m-d H:i:s')."')");
        echo "<script>document.location='index.php?view=kompetensiguru&act=lihat&id=$_POST[jdwl]';</script>";
    }

    $e = mysql_fetch_array(mysql_query("SELECT * FROM jadwal_pelajaran where kodejdwl='$_GET[jdwl]'"));
                ...
                <div class='col-md-12'>
                  ...
                  <input type='hidden' name='jdwl' value='$_GET[jdwl]'>
                    ...
                    <tr><th scope='row'>Mata Pelajaran</th>   <td><select class='form-control' name='c'>"; 
                                                $mapel = mysql_query("SELECT * FROM mata_pelajaran");
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE kompetensi_dasar SET ranah = '$_POST[e]',
                                                    kompetensi_dasar = '$_POST[f]' where id_kompetensi_dasar='$_POST[id]'");
        echo "<script>document.location='index.php?view=kompetensiguru&act=lihat&id=$_POST[jdwl]';</script>";
    }
    $e = mysql_fetch_array(mysql_query("SELECT a.*, b.kode_pelajaran, b.kode_kelas FROM kompetensi_dasar a JOIN jadwal_pelajaran b ON a.kodejdwl=b.kodejdwl where a.id_kompetensi_dasar='$_GET[id]'"));
