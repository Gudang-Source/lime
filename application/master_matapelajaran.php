              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM mata_pelajaran a 
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM mata_pelajaran where kode_pelajaran='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE mata_pelajaran SET kode_pelajaran = '$_POST[a]',
    ...
    $edit = mysql_query("SELECT * FROM mata_pelajaran where kode_pelajaran='$_GET[id]'");
                  ...
                  <tbody>
                    ...
                    <tr><th width='140px' scope='row'>Kurikulum</th> <td><select class='form-control' name='e'> 
                             <option value='0' selected>- Pilih Kurikulum -</option>"; 
                              $kurikulum = mysql_query("SELECT * FROM kurikulum");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO mata_pelajaran VALUES('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]',
    ...
    $edit = mysql_query("SELECT a.*, b.nama_kelompok_mata_pelajaran, c.nama_guru, d.nama_kurikulum, e.nama_jurusan FROM mata_pelajaran a 
