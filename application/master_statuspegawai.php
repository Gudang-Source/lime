              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM status_kepegawaian ORDER BY id_status_kepegawaian DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM status_kepegawaian where id_status_kepegawaian='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE status_kepegawaian SET status_kepegawaian = '$_POST[a]',
                                                      keterangan = '$_POST[b]' where id_status_kepegawaian='$_POST[id]'");
      echo "<script>document.location='index.php?view=statuspegawai';</script>";
    }
    $edit = mysql_query("SELECT * FROM status_kepegawaian where id_status_kepegawaian='$_GET[id]'");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO status_kepegawaian VALUES('','$_POST[a]','$_POST[b]')");
        echo "<script>document.location='index.php?view=statuspegawai';</script>";
    }
