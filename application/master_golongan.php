              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM golongan ORDER BY id_golongan DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM golongan where id_golongan='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE golongan SET id_golongan = '$_POST[a]',
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO golongan VALUES('','$_POST[a]','$_POST[b]')");
        echo "<script>document.location='index.php?view=golongan';</script>";
    }
