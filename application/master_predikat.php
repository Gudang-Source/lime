              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT a.id_predikat, a.nilai_a, a.nilai_b, a.grade, a.keterangan, a.kode_kelas as akelas,  b.nama_kelas FROM predikat a LEFT JOIN kelas b ON a.kode_kelas=b.kode_kelas ORDER BY a.id_predikat DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM predikat where id_predikat='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE predikat SET kode_kelas = '$_POST[aa]', 
                                         nilai_a = '$_POST[a]',
                                         nilai_b = '$_POST[b]',
                                         grade = '$_POST[c]',
    ...
    $edit = mysql_query("SELECT * FROM predikat where id_predikat='$_GET[id]'");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO predikat VALUES('','$_POST[aa]','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]')");
        echo "<script>document.location='index.php?view=predikat';</script>";
    }
