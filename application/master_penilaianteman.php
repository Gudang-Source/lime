                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM pertanyaan_penilaian where id_pertanyaan_penilaian='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE pertanyaan_penilaian SET pertanyaan = '$_POST[a]' where id_pertanyaan_penilaian='$_POST[id]'");
      echo "<script>document.location='index.php?view=penilaianteman';</script>";
    }
    $edit = mysql_query("SELECT * FROM pertanyaan_penilaian where id_pertanyaan_penilaian='$_GET[id]'");
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO pertanyaan_penilaian VALUES('','$_POST[a]','teman','".date('Y-m-d H:i:s')."')");
        echo "<script>document.location='index.php?view=penilaianteman';</script>";
    }
