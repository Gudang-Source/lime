              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysql_query("SELECT * FROM halaman where status='psb' ORDER BY id_halaman DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                      ...
                      if (isset($_GET[hapus])){
                          mysql_query("DELETE FROM halaman where id_halaman='$_GET[hapus]'");
...
<?php 
    ...
    if (isset($_POST[tambah])){
        $judul = seo_title($_POST[a]);
        mysql_query("INSERT INTO halaman VALUES('','$_POST[a]','$judul','$_POST[b]','$_SESSION[id]','journal')");
        echo "<script>document.location='index.php?view=psbhalaman';</script>";
    }
