...
<?php 
              ...
              <div class='box'>
                ...
                <div class='box-body'>
                  ...
                  <table id='example' class='table table-bordered table-striped'>
                    ...
                    <tbody>";
                      $tampil = mysql_query("SELECT * FROM journal_list where kodejdwl='$_GET[id]' ORDER BY id_journal DESC");
                    $no = 1;
                    while($r=mysql_fetch_array($tampil)){
                    echo "<tr><td>$no</td>
                              <td>$r[hari]</td>
                      ...
                      if (isset($_GET[hapus])){
                        mysql_query("DELETE FROM journal_list where id_journal='$_GET[hapus]'");
    ...
    if (isset($_POST[tambah])){
        ...
        mysql_query("INSERT INTO journal_list VALUES('','$_POST[jdwl]','$_POST[c]','$d','$_POST[e]','$_POST[f]','$_POST[g]','".date('Y-m-d H:i:s')."','$_SESSION[id]')");
    ...
    $jam = mysql_num_rows(mysql_query("SELECT * FROM journal_list where kodejdwl='$_GET[jdwl]'"))+1;
    ...
    if (isset($_POST[update])){
        $d = tgl_simpan($_POST[d]);
        mysql_query("UPDATE journal_list SET hari = '$_POST[c]',
                                                tanggal = '$d',
                                                jam_ke = '$_POST[e]',
                                                materi = '$_POST[f]',
                                                keterangan = '$_POST[g]',
    ...
    $e = mysql_fetch_array(mysql_query("SELECT a.*, b.kode_pelajaran, b.kode_kelas FROM journal_list a JOIN jadwal_pelajaran b ON a.kodejdwl=b.kodejdwl where a.id_journal='$_GET[id]'"));
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
