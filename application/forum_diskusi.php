              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php
                    ...
                    $total = mysql_num_rows(mysql_query("SELECT * FROM forum_topic where kodejdwl='$r[kodejdwl]'"));
                    echo "<tr><td>$no</td>
              ...
              <table class='table table-condensed table-hover'>
                ...
                <div class='col-md-12'>
                  <table id='example1' class='table table-condensed table-bordered table-striped'>
                    ...
                    $no = 1;
                    $tampil = mysql_query("SELECT * FROM forum_topic where kodejdwl='$_GET[jdwl]' ORDER BY id_forum_topic DESC");
                    while($r=mysql_fetch_array($tampil)){
                    $ko = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM forum_komentar where id_forum_topic='$r[id_forum_topic]'"));
                    echo "<tr>
                            <td>$no</td>
...
cek_session_guru();
  if (isset($_POST[tambah])){
    ...
    mysql_query("INSERT INTO forum_topic VALUES ('','$_GET[jdwl]','$_POST[a]','$_POST[b]','$waktu')");
...
cek_session_siswa();
  $topic = mysql_fetch_array(mysql_query("SELECT * FROM forum_topic a 
  ...
  if (isset($_GET[deletetopic])){
      mysql_query("DELETE FROM forum_topic where id_forum_topic='$_GET[idtopic]'");
  ...
  if (isset($_GET[deletekomentar])){
      mysql_query("DELETE FROM forum_komentar where id_forum_komentar='$_GET[deletekomentar]' AND id_forum_topic='$_GET[idtopic]'");
      echo "<script>document.location='index.php?view=forum&act=detailtopic&jdwl=".$_GET[jdwl]."&idtopic=".$_GET[idtopic]."&id=".$_GET[id]."&kd=".$_GET[kd]."';</script>";
  }
    ...
    echo "<div class='col-md-12'>
          ...
          <div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-body chat' id='chat-box'>";
                $komentar = mysql_query("SELECT * FROM forum_komentar a 
          ...
          if (isset($_POST[komentar])){
              $waktu = date("Y-m-d H:i:s");
              mysql_query("INSERT INTO forum_komentar VALUES('','$_GET[idtopic]','$_SESSION[id]','$_POST[a]','$waktu')");
              echo "<script>document.location='index.php?view=forum&act=detailtopic&jdwl=".$_GET[jdwl]."&idtopic=".$_GET[idtopic]."&id=".$_GET[id]."&kd=".$_GET[kd]."';</script>";
          }
...
?>
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?php if (isset($_GET[tahun])){ echo "Forum Diskusi"; }else{ echo "Forum Diskusi Pada ".date('Y'); } ?></h3>
                  <form style='margin-right:5px; margin-top:0px' class='pull-right' action='' method='GET'>
                    <input type="hidden" name='view' value='forum'>
