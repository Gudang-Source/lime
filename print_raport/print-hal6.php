...
$skp = mysql_fetch_array(mysql_query("SELECT * FROM nilai_sikap_semester where id_tahun_akademik='$_GET[tahun]' AND nisn='$_GET[id]' AND kode_kelas='$_GET[kelas]'")); 
?>
<html>
<head>
...
echo "<b>C. Extrakulikuler</b>
      <table id='tablemodul1' width=100% border=1>
          ...
          $extra = mysql_query("SELECT * FROM nilai_extrakulikuler where id_tahun_akademik='$_GET[tahun]' AND nisn='$_GET[id]' AND kode_kelas='$_GET[kelas]'");
          $no = 1;
...
echo "<b>D. Prestasi</b>
      <table id='tablemodul1' width=100% border=1>
          ...
          $prestasi = mysql_query("SELECT * FROM nilai_prestasi where id_tahun_akademik='$_GET[tahun]' AND nisn='$_GET[id]' AND kode_kelas='$_GET[kelas]'");
          $no = 1;
