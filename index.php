<?php 
  ...
  if (isset($_SESSION[id])){
      if ($_SESSION[level]=='superuser'){
          ...
          $iden = mysql_fetch_array(mysql_query("SELECT * FROM users where id_user='$_SESSION[id]'"));
            $gu = mysql_fetch_array(mysql_query("SELECT * FROM guru where nip='$iden[username]'"));
           $nama =  $iden[nama_lengkap];
          ...
          $iden = mysql_fetch_array(mysql_query("SELECT * FROM guru where nip='$_SESSION[id]'"));
           $nama =  $iden[nama_guru];
           $level = 'Guru / Pengajar';
           if (trim($iden[foto])==''){
              $foto = 'foto_siswa/no-image.jpg';
          ...
          $iden = mysql_fetch_array(mysql_query("SELECT * FROM siswa where nisn='$_SESSION[id]'"));
           $nama =  $iden[nama];
           $level = 'Siswa / Murid';
           if (trim($iden[foto])==''){
              $foto = 'foto_siswa/no-image.jpg';
      ...
      $kurikulum = mysql_fetch_array(mysql_query("SELECT * FROM kurikulum where status_kurikulum='Ya'"));
?>
<!DOCTYPE html>
<html>
  <head>
